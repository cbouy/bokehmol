...
from bokehmol.tools.rdkit_hover import RDKitHover
from bokehmol.tools.smilesdrawer_hover import SmilesDrawerHover

Tooltips = t.Optional[t.Union[str, t.List[t.Tuple[str, str]]]]


class Hover:
    """Class that wraps calls to the underlying hover tools"""
